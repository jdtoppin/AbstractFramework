...
- Add Bag_All/Bag_Empty/Bag_IndividualBags/Bag_Misc plus Bag_Bag/Bag_ProfessionTool/Bag_ProfessionEquipment/Bag_Miscellaneous adaptive icons for bag sidebar fallback and category states (the rest of the original Bag_* set was pruned after BFInfinite's Bags sidebar v2 moved consumable-subclass and equipment-slot icons to native client art)
