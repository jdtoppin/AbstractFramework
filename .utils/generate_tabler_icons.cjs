...
const ICONS = {
    ...
    Bag_Reagent: "flask",
    Bag_Recipes: "book-2",
    Bag_Slot_Back: "windsock",
    Bag_Slot_Bag: "shopping-bag",
    Bag_Slot_Chest: "shirt",
    Bag_Slot_Feet: "shoe",
    Bag_Slot_Finger: "diamond",
    Bag_Slot_Hands: "hand-stop",
    Bag_Slot_Head: "helmet",
    Bag_Slot_Legs: "layout-bottombar",
    Bag_Slot_MainHand: "sword",
    Bag_Slot_Neck: "medal",
    Bag_Slot_OffHand: "shield",
    Bag_Slot_OneHand: "axe",
    Bag_Slot_ProfessionGear: "badge",
    Bag_Slot_ProfessionTool: "hammer",
    Bag_Slot_Ranged: "bow",
    Bag_Slot_Shirt: "shirt-sport",
    Bag_Slot_Shoulder: "military-rank",
    Bag_Slot_Tabard: "flag",
    Bag_Slot_Trinket: "sparkles",
    Bag_Slot_TwoHand: "swords",
    Bag_Slot_Waist: "layout-align-middle",
    Bag_Slot_Wrist: "circles",
